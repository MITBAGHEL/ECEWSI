...
<link
	href="<%=request.getContextPath()%>/userResources/css/icons.min.css"
	rel="stylesheet" type="text/css">
<link href="<%=request.getContextPath()%>/userResources/css/app.min.css"
...
<body
							...
							<div class="account-box">
								...
								<div class="account-content text-center mt-4">
									...
									<p class="text-muted mt-3">
										Why not try refreshing your page? or you can contact <b>Support</b>
									</p>
									<a
										class="btn btn-md btn-block btn-primary waves-effect waves-light mt-20"
										href="index"> Return Home</a>
								</div>
	...
	<!-- Vendor js -->
	<script
		src="<%=request.getContextPath() %>/userResources/js/vendor.min.js"></script>

	<!-- App js -->
	<script
		src="<%=request.getContextPath() %>/userResources/js/app.min.js"></script>
