                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card-box widget-box-two widget-two-custom">
                                    ...
                                    <div class="wigdet-two-content">
                                        <p class="m-0 text-uppercase font-bold font-secondary text-overflow" title="Statistics">Our Users</p>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card-box widget-box-two widget-two-custom">
                                    ...
                                    <div class="wigdet-two-content">
                                        ...
                                        <h2 class="font-600"><span data-plugin="counterup">${numberOfOrder}</span></h2>
                                    </div>
                                </div>
                            </div><!-- end col -->
