						...
						<div class="col-12">
							<div class="card-box table-responsive">
								...
								<table id="datatable-buttons"
									...
									<tbody>
										<c:forEach var="i" items="${orderList}" varStatus="j">
										<tr>
											<td>${j.count}</td>
											<td>${i.purchaseDate}</td>
											<td>${i.productVO.subProductName}</td>
											<td><a href="generateInvoiceById?id=${i.loginVO.loginId}&purchaseDate=${i.purchaseDate}">Invoice</a></td>
										</tr>
										</c:forEach>
