		...
		<div class="content-page">
			...
			<div class="content">
				<div class="container-fluid">
					...
					<c:forEach var="i" items="${categoryList}"  varStatus="j">
									<tbody>
										<tr>
											<td>${j.count}</td>
											<td>${i.categoryName }</td>
											<td>${i.categoryDiscription}</td>
											<td><a href="editCategory?id=${i.id}"><i class="typcn typcn-pencil"></i></a> / <a href="deleteCategory?id=${i.id}"><i class="typcn typcn-trash"></i></a></td>
										</tr>
									</tbody>
					</c:forEach>
								</table>
