					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box">
								<h4 class="page-title float-left">View Block</h4>

								<ol class="breadcrumb float-right">
									<li class="breadcrumb-item"><a href="#">Home</a></li>
									<li class="breadcrumb-item"><a href="#">Manage Block</a></li>
							...
							<div class="card-box table-responsive">
								...
								<table id="datatable-buttons"
									...
									<thead>
										...
										<tbody>
										<s:forEach var="i" items="${BlockList}"  varStatus="j">
										<tr>
											<td>${j.count}</td>
											<td>${i.block }</td>
											<td>${i.floorVO.floor}</td>
											<td>${i.blockDiscription}</td>
											<td><a href="editBlock?id=${i.id}&id1=${i.floorVO.id}"><i class="typcn typcn-pencil"></i></a> /  <a href="deleteBlock?id=${i.id}&id1=${i.floorVO.id}"><i class="typcn typcn-trash"></i></a></td>
										</tr>
											</s:forEach>
									</tbody>
