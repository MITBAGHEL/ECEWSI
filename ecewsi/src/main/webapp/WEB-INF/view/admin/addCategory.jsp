	              ...
	              <div class="row">
                            <div class="col-lg-12">
                                 ...
                                 <div class="card-box">
                                    ...
                                    <f:form action="insertCategory" method="post" modelAttribute="CategoryVO" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="emailAddress">Add Category<span class="text-danger">*</span></label>
                                            <f:input type="category" path="categoryName" parsley-trigger="change" 
                                                    class="form-control" id="emailAddress"/>
                                        </div>
                                       <div class="form-group">
                                             <label for="example-textarea">Add Description<span class="text-danger">*</span></label>
                                             <div >
                                             <f:textarea class="form-control" path="categoryDiscription" rows="5" id="example-textarea" spellcheck="false"/>
                                             </div>                   
                                        </div>
