                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <s:form class="" modelAttribute="StoreVO" action="insertStore" method="post">
                                        <div class="form-group">
                                            <label class="col-4 col-form-label">Add Store</label>
                                            <s:input type="text" class="form-control" path="storeNumber" />
                                        </div>
                                        <div class="form-group">
                                           <label class="col-4 col-form-label">Add Store Name</label>
                                            <s:input type="text" class="form-control" path="storeName" />
                                        </div>
