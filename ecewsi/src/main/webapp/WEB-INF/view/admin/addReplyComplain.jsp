                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">ADD Reply</h4>
	              ...
	              <div class="row">
                            <div class="col-lg-12">
                                 ...
                                 <div class="card-box">
                                    ...
                                    <f:form action="insertReply" method="post" modelAttribute="complaintVO" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="emailAddress">Complain Subject<span class="text-danger">*</span></label>
                                            <f:input type="category" path="complaintSubject" parsley-trigger="change" required="required" 
                                                  readOnly = "true" class="form-control" id="emailAddress"/>
                                        </div>
                                       <div class="form-group">
                                             <label for="example-textarea">Complain Discription<span class="text-danger">*</span></label>
                                             <div >
                                             <f:textarea class="form-control" path="complaintDescription" required="required" rows="5" id="example-textarea" spellcheck="false" readOnly = "true"/>
                                             </div>                   
                                        </div>
                                        
                                        <div class="form-group">
                                             <label for="example-textarea">Add Reply<span class="text-danger">*</span></label>
                                             <div >
                                             <f:textarea class="form-control" path="reply" rows="5" id="example-textarea" spellcheck="false"/>
                                             </div>                   
                                        </div>
