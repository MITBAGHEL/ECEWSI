					...
					<div class="row">
						<div class="col-12">
							<div class="page-title-box">
								<h4 class="page-title float-left">View Floor</h4>

								<ol class="breadcrumb float-right">
									<li class="breadcrumb-item"><a href="#">Home</a></li>
									<li class="breadcrumb-item"><a href="#">Manage Floor</a></li>
									<li class="breadcrumb-item active">View Floor</li>
								</ol>
						...
						<div class="col-12">
							<div class="card-box table-responsive">
								...
								<table id="datatable-buttons"
									...
									<s:forEach var="i" items="${FloorList}"  varStatus="j">
									<tbody>
										<tr>
											<td>${j.count}</td>
											<td>${i.floor}</td>
											<td>${i.floorDiscription}</td>
											<td><a href="flooredit?id=${i.id}"><i class="typcn typcn-pencil"></i></a> /  <a href="floordelete?id=${i.id}"><i class="typcn typcn-trash"></i></a></td>
										</tr>
									</tbody>
									</s:forEach>
								</table>
