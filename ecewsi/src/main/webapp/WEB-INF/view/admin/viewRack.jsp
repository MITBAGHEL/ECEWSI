						...
						<div class="col-12">
							<div class="card-box table-responsive">
								...
								<table id="datatable-buttons"
									...
									<tbody>
									<c:forEach var="i" items="${rackList}"  varStatus="j">
										<tr>
											<td>${j.count}</td>
											<td>${i.blockVO.block}</td>
											<td>${i.floorVO.floor}</td>
											<td>${i.rack}</td>
											<td><a href="editRack?id=${i.id}"><i class="typcn typcn-pencil"></i></a> / <a href="deleteRack?id=${i.id}"><i class="typcn typcn-trash"></i></a></td>
										</tr>
										</c:forEach>
									</tbody>
								</table>
