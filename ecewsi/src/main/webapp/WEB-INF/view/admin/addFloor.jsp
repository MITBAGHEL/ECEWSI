	              ...
	              <div class="row">
                            <div class="col-lg-12">
                                 ...
                                 <div class="card-box">
                                    ...
                                    <c:form action="insertFloor" method="post" modelAttribute="FloorVO">
                                        ...
                                        <c:hidden path="id"/>
                                         <div class="form-group">
                                            ...
                                            <div>
                                                <c:input data-parsley-type="number" type="id"
                                       ...
                                       <div class="form-group">
                                             ...
                                             <div >
                                             <c:textarea class="form-control" rows="5" id="example-textarea" spellcheck="false" path="floorDiscription"/>
                                             </div>
